...
#ifndef LIBKMGRAPH2_CONTACTCREATEJOB_H
#define LIBKMGRAPH2_CONTACTCREATEJOB_H
 ...
 * @since 2.0
 */
class KMGRAPHCONTACTS_EXPORT ContactCreateJob : public KMGraph2::CreateJob
{
    Q_OBJECT
  public:
...
#endif // LIBKMGRAPH2_CONTACTCREATEJOB_H
