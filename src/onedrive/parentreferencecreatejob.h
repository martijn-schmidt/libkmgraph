...
#ifndef KMGRAPH2_ONEDRIVEPARENTREFERENCECREATEJOB_H
#define KMGRAPH2_ONEDRIVEPARENTREFERENCECREATEJOB_H
...
class KMGRAPHONEDRIVE_EXPORT ParentReferenceCreateJob : public KMGraph2::CreateJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEPARENTREFERENCECREATEJOB_H
