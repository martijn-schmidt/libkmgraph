...
#ifndef KMGRAPH2_ONEDRIVEFILEABSTRACTMODIFYJOB_H
#define KMGRAPH2_ONEDRIVEFILEABSTRACTMODIFYJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileAbstractModifyJob : public KMGraph2::ModifyJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEFILEABSTRACTMODIFYJOB_H
