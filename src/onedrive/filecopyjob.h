...
#ifndef KMGRAPH2_ONEDRIVEFILECOPYJOB_H
#define KMGRAPH2_ONEDRIVEFILECOPYJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileCopyJob : public KMGraph2::OneDrive::FileAbstractDataJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEFILECOPYJOB_H
