...
#ifndef LIBKMGRAPH2_ONEDRIVEFILE_H
#define LIBKMGRAPH2_ONEDRIVEFILE_H
...
Q_DECLARE_OPERATORS_FOR_FLAGS(KMGraph2::OneDrive::File::SerializationOptions)

#endif // LIBKMGRAPH2_ONEDRIVEFILE_H
