...
#ifndef KMGRAPH2_ONEDRIVEFILEABSTRACTUPLOADJOB_H
#define KMGRAPH2_ONEDRIVEFILEABSTRACTUPLOADJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileAbstractUploadJob : public KMGraph2::OneDrive::FileAbstractDataJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEFILEABSTRACTUPLOADJOB_H
