...
#ifndef KMGRAPH2_ONEDRIVE_FILEFETCHCONTENTJOB_H
#define KMGRAPH2_ONEDRIVE_FILEFETCHCONTENTJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileFetchContentJob : public KMGraph2::FetchJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVE_FILEFETCHCONTENTJOB_H
