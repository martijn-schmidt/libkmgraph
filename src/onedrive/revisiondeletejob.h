...
#ifndef KMGRAPH2_ONEDRIVEREVISIONDELETEJOB_H
#define KMGRAPH2_ONEDRIVEREVISIONDELETEJOB_H
...
class KMGRAPHONEDRIVE_EXPORT RevisionDeleteJob : public KMGraph2::DeleteJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEREVISIONDELETEJOB_H
