...
#ifndef KMGRAPH2_ONEDRIVEFILEFETCHJOB_H
#define KMGRAPH2_ONEDRIVEFILEFETCHJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileFetchJob : public KMGraph2::FetchJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEFILEFETCHJOB_H
