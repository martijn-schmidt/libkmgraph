...
#ifndef KMGRAPH2_ONEDRIVEFILEMODIFYJOB_H
#define KMGRAPH2_ONEDRIVEFILEMODIFYJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileModifyJob : public KMGraph2::OneDrive::FileAbstractUploadJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEFILEMODIFYJOB_H
