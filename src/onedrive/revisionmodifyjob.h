...
#ifndef KMGRAPH2_ONEDRIVEREVISIONMODIFYJOB_H
#define KMGRAPH2_ONEDRIVEREVISIONMODIFYJOB_H
...
class KMGRAPHONEDRIVE_EXPORT RevisionModifyJob : public KMGraph2::ModifyJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEREVISIONMODIFYJOB_H
