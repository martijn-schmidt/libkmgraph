...
#ifndef KMGRAPH2_ONEDRIVEFILETOUCHJOB_H
#define KMGRAPH2_ONEDRIVEFILETOUCHJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileTouchJob : public KMGraph2::OneDrive::FileAbstractModifyJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEFILETOUCHJOB_H
