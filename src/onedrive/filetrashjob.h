...
#ifndef KMGRAPH2_ONEDRIVEFILETRASHJOB_H
#define KMGRAPH2_ONEDRIVEFILETRASHJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileTrashJob : public KMGraph2::OneDrive::FileAbstractModifyJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEFILETRASHJOB_H
