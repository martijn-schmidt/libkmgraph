...
#ifndef LIBKMGRAPH2_ONEDRIVEPARENTREFERENCE_H
#define LIBKMGRAPH2_ONEDRIVEPARENTREFERENCE_H
 ...
 * @see <a href="https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/api/driveitem_get">DriveItem Get item with $select=parentReference</a>
 *
 * @since 2.0
 * @author Andrius da Costa Ribas <andriusmao@gmail.com>
 * @author Daniel Vrátil <dvratil@redhat.com>
 */
class KMGRAPHONEDRIVE_EXPORT ParentReference: public KMGraph2::Object
{
...
#endif // LIBKMGRAPH2_ONEDRIVEPARENTREFERENCE_H
