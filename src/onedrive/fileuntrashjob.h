...
#ifndef KMGRAPH2_ONEDRIVEFILEUNTRASHJOB_H
#define KMGRAPH2_ONEDRIVEFILEUNTRASHJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileUntrashJob : public KMGraph2::OneDrive::FileAbstractModifyJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEFILEUNTRASHJOB_H
