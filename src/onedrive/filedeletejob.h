...
#ifndef KMGRAPH2_ONEDRIVEFILEDELETEJOB_H
#define KMGRAPH2_ONEDRIVEFILEDELETEJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileDeleteJob : public KMGraph2::DeleteJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEFILEDELETEJOB_H
