...
#ifndef KMGRAPH2_ONEDRIVECHANGEFETCHJOB_H
#define KMGRAPH2_ONEDRIVECHANGEFETCHJOB_H
...
class KMGRAPHONEDRIVE_EXPORT ChangeFetchJob : public KMGraph2::FetchJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVECHANGEFETCHJOB_H
