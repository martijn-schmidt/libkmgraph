...
#ifndef KMGRAPH2_ONEDRIVEFILECREATEJOB_H
#define KMGRAPH2_ONEDRIVEFILECREATEJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileCreateJob : public KMGraph2::OneDrive::FileAbstractUploadJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEFILECREATEJOB_H
