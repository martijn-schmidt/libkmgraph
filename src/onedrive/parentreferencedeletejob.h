...
#ifndef KMGRAPH2_ONEDRIVEPARENTREFERENCEDELETEJOB_H
#define KMGRAPH2_ONEDRIVEPARENTREFERENCEDELETEJOB_H
...
class KMGRAPHONEDRIVE_EXPORT ParentReferenceDeleteJob : public KMGraph2::DeleteJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_ONEDRIVEPARENTREFERENCEDELETEJOB_H
