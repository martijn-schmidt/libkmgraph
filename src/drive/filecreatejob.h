...
#ifndef KMGRAPH2_DRIVEFILECREATEJOB_H
#define KMGRAPH2_DRIVEFILECREATEJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileCreateJob : public KMGraph2::Drive::FileAbstractUploadJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_DRIVEFILECREATEJOB_H
