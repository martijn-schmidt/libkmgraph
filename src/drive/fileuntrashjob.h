...
#ifndef KMGRAPH2_DRIVEFILEUNTRASHJOB_H
#define KMGRAPH2_DRIVEFILEUNTRASHJOB_H
...
class KMGRAPHONEDRIVE_EXPORT FileUntrashJob : public KMGraph2::Drive::FileAbstractModifyJob
{
    Q_OBJECT
...
#endif // KMGRAPH2_DRIVEFILEUNTRASHJOB_H
